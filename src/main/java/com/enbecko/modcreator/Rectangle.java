...
public abstract class Rectangle {
    ...
    public static class Textured extends Polygon <vec3Vert.PosTex> {
        ...
        public Textured(Face3D face, vec2.FloatVec uv_LOW_LEFT, vec2.FloatVec uv_LOW_RIGHT, vec2.FloatVec uv_TOP_RIGHT, vec2.FloatVec uv_TOP_LEFT, boolean autoUpdate) {
        ...
        public Textured(Face3D face, boolean autoUpdate) {
    ...
    public static class Colored extends Polygon <vec3Vert.PosCol> {
        ...
        public Colored(Face3D face, vec4.FloatVec color, boolean autoUpdate) {
            this(face, color, color, color, color, autoUpdate);
        }

        public Colored(Face3D face, boolean autoUpdate) {
